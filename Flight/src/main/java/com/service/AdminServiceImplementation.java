...
public class AdminServiceImplementation implements AdminService{
	...
	public List<FleetMaster> getAllFleetDetail(FleetMaster fleetMaster) {
		return fleetMasterDAO.getAllFleet();
	}
	
	public boolean deleteFlight(int flightId) {
		return flightMasterDAO.deleteFlight(flightId);
	}
	public List<LocationMaster> getAllLocationDetail(LocationMaster locationMaster) {
		return locationMasterDAO.getAllLocation();
	}
}
